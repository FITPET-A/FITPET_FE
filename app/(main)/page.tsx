...
export default function MainPage() {
  ...
  return (
    <div className="relative mt-[88px] flex flex-col px-6 tablet:mt-[130px] desktop:mt-[170px] desktop:px-[40px]">
      <div className="hidden font-paperlogy-heading text-white tablet:block tablet:text-[24px] desktop:text-[40px]">
        펫보험 비교 견적서
        <br />
        1분만에 무료로 신청하세요!
      </div>
      <div className="z-10 font-paperlogy-title text-white mobile:text-xl tablet:hidden">
      ...
      <Image
        alt="marty"
        className="absolute -top-[60px] right-[36px] z-0 hidden tablet:block desktop:hidden"
      ...
      <Image
        alt="marty"
        className="absolute -top-12 right-6 z-0 tablet:hidden"
        src={`/assets/${petType}_main_normal.webp`}
        width={220}
        height={311}
      />
