...
export default function LandingSection3() {
  return (
    <section className="mt-[284px] flex h-[529px] flex-col items-center bg-primary-40">
      ...
      <div className="mt-[87px] flex flex-wrap justify-center gap-8">
        {/* 5개 보험사 박스 */}
        <div className="flex h-[108px] w-full max-w-[300px] items-center justify-center rounded-[20px] bg-grayscale-00">
          <Image
