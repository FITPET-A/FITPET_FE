...
export default function LandingSection3() {
  return (
    <section className="mt-[284px] flex h-[529px] w-full flex-col items-center overflow-hidden bg-primary-40">
      ...
      <div className="mt-[87px] flex justify-center gap-8">
        {/* 5개 보험사 박스 */}
        <div className="flex h-[108px] items-center justify-center rounded-[20px] bg-grayscale-00 tablet:w-[240px] desktop:w-[371px]">
          <Image
